...
?><?php echo " ".$_SESSION['name'];?>
            ...
            <div class="navbar-default sidebar scroll" role="navigation">
               ...
               <div class="col-xs-pull-4 col-md-offset-9">
            <h2 class="page-header"><?php echo $_SESSION['last_name']."'s ";?>Courses</h2>
            <?php
            ...
            while($courses = mysqli_fetch_assoc($course)){
            ?>
            <?php if($courses['course_department']== 4)
            {?>
                <div class="panel panel-yellow">
           <?php 
            }elseif($courses['course_department']==1){?>
                <div class="panel panel-red">
            <?php }elseif($courses['course_department']==7){?>
                  <div class="panel panel-green">  
            <?php }elseif($courses['course_department']==2){?>
                <div class="panel panel-lime">
            <?php }elseif($courses['course_department']==3){?>
                  <div class="panel panel-cyan">  
            <?php }elseif($courses['course_department']==5){?>
                <div class="panel panel-teal">
            <?php }elseif($courses['course_department']==6){?>
                  <div class="panel panel-brown">  
            <?php }elseif($courses['course_department']==8){?>
                <div class="panel panel-orange">
            <?php }elseif($courses['course_department']==9){?>
                  <div class="panel panel-blue">  
            <?php }elseif($courses['course_department']==10){?>
                <div class="panel panel-warning">
            <?php }elseif($courses['course_department']==11){?>
                  <div class="panel panel-success">  
            <?php }elseif($courses['course_department']==12){?>
                <div class="panel panel-bluegrey">
            <?php }elseif($courses['course_department']==13){?>
        ...
        ?>
            ...
            <div class="huge"><?php echo $courses['course_code'];?>	   			</div>
            </div>
            </div>
