...
if(isset($_POST['submit'])){
    ...
    if($num_assignment > 0){
     ...
     if(empty($errors)){
        global $connection;
        for($i=0; $i<=$j-1; $i++){
             $query = "INSERT INTO final_questions(course_code, question, answer, option_a, option_b, option_c, option_d, due_date) VALUES( '{$course_code}','{$questions[$i]}', '{$answers[$i]}', '{$Aoptions[$i]}', '{$Boptions[$i]}', '{$Coptions[$i]}', '{$Doptions[$i]}', '{$due_date}')";
             $assignment = mysqli_query($connection, $query);
            confirm_query($assignment);
        }
         $query = "INSERT INTO activity_notifications(course_code, notif_type, due_date) VALUES('{$course_code}','Final', '{$due_date}')";
            ...
            <div id="page-wrapper">
                ...
                <div id="title-breadcrumb-option-demo" class="page-title-breadcrumb">
                    ...
                    <ol class="breadcrumb page-breadcrumb pull-right">
                        ...
                        <li class="hidden"><a href="#">Final</a>&nbsp;&nbsp;<i class="fa fa-angle-right"></i>&nbsp;&nbsp;</li>
