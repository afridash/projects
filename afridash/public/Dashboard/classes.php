                    ...
                    <div id="row mbl">
                        ...
                        while($list = mysqli_fetch_assoc($clist)){
                            ...
                            while($course = mysqli_fetch_assoc($classes)){ ?>
                              <ul class="list-group">
                                 <li class="list-group-item"><a href="class_attendance.php?course=<?php echo $course['course_title']?>&course_code=<?php echo $course['course_code']?>"><?php echo $course['course_title']?></a></li>
                            </ul>
                                <?php
                            } 
                         }?>
