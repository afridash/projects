...
$score = 0;
$ans = array();
$query = "SELECT answer FROM quiz_questions WHERE quiz_id = {$_GET['id']} AND course_code = '{$_GET['course_code']}'";
...
$query = "INSERT INTO quiz_scores (quiz_id, course_code, user_id, score) VALUES({$_GET['id']},'{$_GET['course_code']}',{$_SESSION['user_id']}, {$total})";
                ...
                <div id="title-breadcrumb-option-demo" class="page-title-breadcrumb">
                    <div class="page-header pull-left">
                        <div class="page-title">
                            Take Quiz <?php echo $_GET['id']; ?></div>
                    </div>
